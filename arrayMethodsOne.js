...
// CODE HERE
const evenNumbers = mixedNumbers.filter(/* Provide Your Callback Here */ function(value) {
  return !(value % 2)
})
...
// CODE HERE
const postTaxPrices = prices.map(/* Provide Your Callback Here*/ function(value) {
  return 1.07 * value
});
...
// CODE HERE
const totalPopulation = populations.reduce(/* Provide Your Callback Here */ function(result, value) {
  return result + value
})
...
// CODE HERE
const myStrongest = monstersInYourPocket.filter(/* Provide Your Callback Here */ function(value) {
  return 200 < value.CP
})
...
// CODE HERE
console.log(orders.map(function(value) {
  return value.price * (1 + value.tax)
}))
...
// CODE HERE
let bobsTotal = purchases.reduce(function(result, value) {
  if (value.owner === `Bob`) {
    result += value.price
  }
  return result
